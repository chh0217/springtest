...
public class HelloTest {
    ...
    public void testHelloWorld() {
        //1、读取配置文件实例化一个IoC容器
        ApplicationContext context = new ClassPathXmlApplicationContext("kt/chapter2/helloworld.xml");
    ...
    public void test1() {
        BeanFactory beanFactory =
                new ClassPathXmlApplicationContext("kt/chapter2/namingbean1.xml");
        //根据类型获取bean
    ...
    public void test2() {
        BeanFactory beanFactory =
                new ClassPathXmlApplicationContext("kt/chapter2/namingbean2.xml");
        //根据id获取bean
    ...
    public void test3() {
        BeanFactory beanFactory =
                new ClassPathXmlApplicationContext("kt/chapter2/namingbean3.xml");
        //根据name获取bean
        HelloApi bean = beanFactory.getBean("bean", HelloApi.class);
        bean.sayHello();
    }
    ...
    public void test4() {
        BeanFactory beanFactory =
                new ClassPathXmlApplicationContext("kt/chapter2/namingbean4.xml");
        //根据id获取bean
    ...
    public void test5() {
        BeanFactory beanFactory =
                new ClassPathXmlApplicationContext("kt/chapter2/namingbean5.xml");
        //1根据id获取bean
        HelloApi bean1 = beanFactory.getBean("bean1", HelloApi.class);
        bean1.sayHello();
        //2根据别名获取bean
    ...
    public void test6() {
        BeanFactory beanFactory =
                new ClassPathXmlApplicationContext("kt/chapter2/namingbean6.xml");
        //根据id获取bean
        HelloApi bean = beanFactory.getBean("bean", HelloApi.class);
        bean.sayHello();
        //根据别名获取bean
